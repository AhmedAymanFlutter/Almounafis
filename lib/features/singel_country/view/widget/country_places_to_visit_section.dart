...
class CountryPlacesToVisitSection extends StatelessWidget {
  final List<GuidePlace> placesToVisit;

  const CountryPlacesToVisitSection({super.key, required this.placesToVisit});

  @override
  Widget build(BuildContext context) {
    if (placesToVisit.isEmpty) return const SizedBox.shrink();
